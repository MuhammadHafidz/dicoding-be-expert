...
DomainErrorTranslator._directories = {
  ...
  'ADD_THREAD.AUTH_HEADER_NOT_VALID': new AuthenticationError('Authentikasi dibutuhkan'),
  ...
  'COMMENT_LIKE.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat comment like baru karena properti yang dibutuhkan tidak ada'),
  'COMMENT_LIKE.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat membuat comment like baru karena tipe data tidak sesuai'),
};
